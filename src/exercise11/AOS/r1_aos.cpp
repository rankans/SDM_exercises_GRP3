...
{
    r1_distributed_aos_record::r1_distributed_aos_record(std::int64_t column_a, std::string column_b)
        : _column_a(column_a), _column_b(std::move(column_b)) {}
    r1_distributed_aos r1_distributed_aos::generate_relation(size_t X, std::int64_t Y)
    {
        r1_distributed_aos relation;
    ...
    std::vector<std::vector<r1_distributed_aos_record>>
    r1_distributed_aos::local_partitioning_phase(size_t num_workers) const
    {
    ...
    void r1_distributed_aos::shuffle_phase_receive(const std::vector<record_type> &partition_data)
    {
