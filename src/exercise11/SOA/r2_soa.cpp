...
{
    r2_distributed_soa r2_distributed_soa::generate_relation(size_t X, std::int64_t Y)
    {
        r2_distributed_soa relation;
    ...
    r2_distributed_soa::local_partitioning_phase(size_t num_workers) const
    {
    ...
    void r2_distributed_soa::shuffle_phase_receive(const std::vector<std::int64_t> &keys,
