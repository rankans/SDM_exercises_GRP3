...
private:
    ...
    void processQuery(const title_space::title_record &title_table, int64_t year_start, int64_t year_end);
...
public:
    ...
    void runQuery(const title_space::title_record &title_table,
