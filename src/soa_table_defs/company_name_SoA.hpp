...
public:
    static expected<company_name_soa_record, csv::err_t> load_from_file(string_view filePath, char delim = '|');
    ...
    company_name_soa_record() = default;
    ...
    friend std::ostream &operator<<(std::ostream &os, company_name_soa_record const &records)
    {
    ...
    void append_record(const company_name_soa_record &src, size_t i)
    {
        append(
            src.id()[i],
            src.name()[i],
